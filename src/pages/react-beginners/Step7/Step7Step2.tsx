...
export const Step7Step2 = ({
  ...
  return (
    <>
      ...
      <Typography>
        Сейчас наш проект содержит самый основной необходимый набор таких
        библиотек и мы по мере необходимости будем подгружать и устанавливать
        новые
      </Typography>
      <Typography>
      ...
      <Typography>
        Это лишь список, который нужно закачать из интернета (несколько сотен
        мегабайт). Чтобы закачать его, введите в терминале команду{" "}
